 ...
 * TODO description
 */
public class Main extends  Main$$Parser  {
	...
	public static void eval_root() {
		...
		double v = Main$$Parser.sc.nextDouble();
		System.out.println();
		System.out.println("1: sqrt");
		System.out.println("2: nroot");
		System.out.println();
		int sel = Main$$Parser.sc.nextInt();
		double s;
		switch (sel) {
		case 1:
			s = new Root().sqrt(v);
			System.out.println("Solution is "+Double.toString(s));
			Main$$Parser.l.log("sqrt("+Double.toString(v)+")="+Double.toString(s));
			break;
		case 2:
			System.out.print("n=");
			int deg = Main$$Parser.sc.nextInt();
			System.out.println();
			s = new Root().root(v, deg);
			System.out.println("Solution is "+Double.toString(s));
			Main$$Parser.l.log("root("+Double.toString(v)+","+Double.toString(deg)+")="+Double.toString(s));
			break;
		}
	}
	
	public static void eval_base() {
		Main$$Parser.eval_base();
	}
	
	public static Matrix eval_mat() {
		return Main$$Parser.eval_mat();
	}
	
	public static void eval_round() {
		Main$$Parser.eval_round();
	}
	
	public static void eval_logic() {
		Main$$Parser.eval_logic();
	}
	
	public static void eval_trig() {
		Main$$Parser.eval_trig();
	}
